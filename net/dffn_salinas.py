...
https://github.com/weiweisong415/Demo_DFFN_for_TGRS2018/blob/master/prototxt_files/train_salinas.prototxt
"""
...
# Implementation of DFFN with the architecture used for Salinas.
# The sample size that was used is 27x27x10. The 10 channels are obtained by doing a PCA with the input data.
